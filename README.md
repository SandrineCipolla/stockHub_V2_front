...
Composants Web Components Lit, package séparé [@stockhub/design-system](https://github.com/SandrineCipolla/stockhub_design_system). Liste des composants et exemples d'usage : [Storybook](https://68f5fbe10f495706cb168751-nufqfdjaoc.chromatic.com/), pas dupliquée ici. Guide d'intégration React + Web Components : [docs/2-WEB-COMPONENTS-GUIDE.md](docs/2-WEB-COMPONENTS-GUIDE.md).

## Accessibilité

Conformité WCAG 2.1 niveau AA visée : navigation clavier, contrastes validés, ARIA, structure sémantique, support `prefers-reduced-motion`. Rapport d'audit complet : [docs/6-ACCESSIBILITY.md](docs/6-ACCESSIBILITY.md).
