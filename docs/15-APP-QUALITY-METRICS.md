...
**Fichier** : `docs/metrics/data/lighthouse-1765015324279.json`
...
# Dashboard métriques
# Ouvrir http://localhost:5173/docs/metrics/
```
...
2. **Dashboard Métriques** (`/docs/metrics/`)
   - Visualisation des audits
   - URL: http://localhost:5173/docs/metrics/
