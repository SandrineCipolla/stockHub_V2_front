          ...
          <AnimatePresence>
            <>
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    window.innerWidth < 800 ? 'rgba(0, 0, 0, 0.4)' : 'rgba(0, 0, 0, 0.1)',
                }}
              ...
              >
                <div
                  className={`rounded-lg border-2 ${popoverBorderColors[highestPriority.priority]} bg-white dark:bg-gray-800 shadow-2xl ring-1 ring-black/10`}
                >
                  {/* Header */}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-start gap-2 mb-2">
                            <Icon
                              className={`w-4 h-4 mt-0.5 flex-shrink-0 ${suggestionColors.text}`}
                            />
