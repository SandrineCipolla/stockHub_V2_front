  ...
  describe('Basic rendering', () => {
    ...
    describe('when rendered with custom props', () => {
      ...
      it('should update notification badge count', () => {
        const highPriorityCount = getNotificationStats(
          mockNotificationScenarios.highPriority
        ).total;
    ...
    describe('when clicking theme toggle', () => {
      it('should call toggleTheme', async () => {
        ...
        const themeButton = container.querySelector(
          'sh-button[aria-label*="Changer vers le thème"]'
        );
      ...
      it('should work with user theme preferences', () => {
        const userWithLightTheme = {
          ...mockDefaultUser,
          preferences: { ...mockDefaultUser.preferences, theme: 'light' as const },
        }; // NÉCESSAIRE pour le type Theme strict
    ...
    describe('when clicking logout button', () => {
      ...
      it('should render logout button for different users', () => {
        const { container } = render(
          <Header userName={getUserDisplayName(mockUserScenarios.wealthyUser)} />
        );
